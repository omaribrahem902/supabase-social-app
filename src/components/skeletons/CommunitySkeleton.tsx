export const CommunitySkeleton = () => {
  return (
    <div className="animate-pulse lg:w-[1042px] max-w-5xl h-[94px] flex justify-between items-center mx-auto py-2 lg:py-4 px-2 lg:px-7 rounded-xl lg:rounded-2xl space-y-4 p-4 border border-gray-400 shadow-2xs">
